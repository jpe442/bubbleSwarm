...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__timer__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__bubble__ = __webpack_require__(4);
...
class Game {
  constructor() {
    ...
    this.addBubbles();
    this.points = 0;
    this.timer = new __WEBPACK_IMPORTED_MODULE_0__timer__["a" /* default */](5);
  }
  ...
  addBubbles() {
    for (let i = 0; i < Game.NUM_BUBBLES; i++) {
      this.add(new __WEBPACK_IMPORTED_MODULE_1__bubble__["a" /* default */]({ game: this }));
    }
  };
