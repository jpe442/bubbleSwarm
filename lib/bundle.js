...
class Game {
  ...
  addBubbles() {
    ...
    for (let i = 0; i < Game.NUM_BUBBLES/2; i++) {
      this.add(new __WEBPACK_IMPORTED_MODULE_2__bubble__["a" /* default */]({ game: this, radius: stage.RADIUS_A, color: stage.COLOR_A }));
    }
    for (let i = 0; i < Game.NUM_BUBBLES/2; i++) {
      this.add(new __WEBPACK_IMPORTED_MODULE_2__bubble__["a" /* default */]({ game: this, radius: stage.RADIUS_B, color: stage.COLOR_B, pointVal: 20, vel: __WEBPACK_IMPORTED_MODULE_0__utils__["a" /* default */].randomVec(2) }));
    }
  };
